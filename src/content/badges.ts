...
export const BADGES: Badge[] = [
  ...
  // --- HTML & CSS 16-WEEK COURSE BADGES ---
  {
    ...
    description: 'Làm chủ thẻ tiêu đề, đoạn văn, ảnh đại diện, danh sách và khung semantic (Tuần 1 - 4)',
    icon: '🌐',
    requirement: 'Hoàn thành Giai đoạn 1 (Tuần 1 - 4)',
    course: 'html-css',
  },
  {
    id: 'css_color_wizard',
    title: 'Phù Thủy Sắc Màu & Viền',
    description: 'Thành thạo phối màu, đổi font chữ, bo tròn avatar và đổ bóng khối (Tuần 5 - 6)',
    icon: '🎨',
    requirement: 'Hoàn thành Tuần 5 & 6',
    course: 'html-css',
  },
  {
    id: 'box_model_master',
    title: 'Bậc Thầy Box Model & Hover',
    description: 'Làm chủ khoảng cách Padding, Margin, căn giữa và hiệu ứng di chuột (Tuần 7 - 8)',
    icon: '📦',
    requirement: 'Hoàn thành Tuần 7 & 8',
    course: 'html-css',
  },
  {
    id: 'flexbox_ninja',
    title: 'Ninja Bố Cục Flexbox',
    description: 'Thành thạo dàn hàng ngang, căn giữa trục và tạo lưới thư viện ảnh (Tuần 9 - 11)',
    icon: '📐',
    requirement: 'Hoàn thành Tuần 9, 10 & 11',
    course: 'html-css',
  },
  {
    id: 'responsive_engineer',
    title: 'Kỹ Sư Responsive',
    description: 'Làm chủ thẻ Viewport và Media Query giúp trang web hiển thị đẹp trên điện thoại (Tuần 12)',
    icon: '📱',
    requirement: 'Hoàn thành Tuần 12 (Responsive)',
    course: 'html-css',
  },
  {
    id: 'personal_web_author',
    title: 'Tác Giả Website Cá Nhân',
    description: 'Xuất sắc hoàn thành Đồ án Tốt nghiệp - Tự tay xây dựng Trang web cá nhân hoàn chỉnh (Tuần 13 - 16)',
    icon: '👑',
    requirement: 'Hoàn thành trọn vẹn 16 tuần học HTML & CSS',
    course: 'html-css',
  },
];
